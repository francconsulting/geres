...
function Table(){
   ...
   tabla =  $('#listaUsuario').DataTable({
       ...
       "ajax" : {
            "method" : "POST",
            "url" : "app/mod/user/view/modules/datos.php"
       },
       "columns":[
           {"data":"num"},
           {"data": "sAvatar" ,
            "render" : function(data,type,row){
              // console.log("imagen " +data + " tipo: "+type + " fila: "+row.sNombre);
               return '<img src="/geres/app/images/avatar/'+data+'" width="25" class="img-circle" title="'+row.sNombre+" "+row.sApellidos+'" alt="Avatar usuario">';
            }
           },
           {"data":"idUser"},
           {"data":"sNombre"},

...
//require_once (PATH . PROJECT . APP ."/lib/footerForm.php");
...
<div class="row">
    <div class="col-xs-12 col-md-12">
        <div class="text-left">
            <button type='button' id="addUser" class='ver btn btn-primary right'><i class='glyphicon glyphicon-user'></i> Nuevo usuario</button>
        </div>
    </div>
</div>
...
<div class="row">
    <div class="col-xs-12 col-md-12">
        <div class="text-right">
            <button type='button' id="idRecarga" class='ver btn btn-primary'><i class='glyphicon glyphicon-repeat'></i> Actualizar tabla</button>
        </div>
    </div>
</div>

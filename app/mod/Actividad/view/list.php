...
<div class="row">
    <div class="col-xs-12 col-md-12">
        <div class="text-left">
            <button type='button' id="addActividad" class='ver btn bg-olive right'><i
                        class='glyphicon glyphicon-tags'></i> Nueva actividad
            </button>
        </div>
    </div>
</div>
...
<div class="box">
    ...
    <div class="box-body">
        <table id="listaActividad" class="table table-bordered table-striped dataTable" cellpadding="3" cellspacing="2">
            <thead>
            <tr>
                <th>nº</th>
                <th>idActividad</th>

        ...
        <div class="col-md-3">
            ...
            <div class="box box-primary">
                <div class="box-body box-profile">
                    ...
                    <div id="avatar" class="profile-user-img img-responsive img-circle" src="" alt="User profile picture"></div>
                ...
                <div class="tab-content">
                    ...
                    <div class="active tab-pane" id="settings">
                        <form id="profile" enctype="multipart/form-data" class="form-horizontal" data-toggle="validator">
                            ...
                            <div class="form-group">
                                <label for="tDescripción" class="col-sm-2 control-label">Descripción</label>

                                <div class="col-sm-10">
                                    <textarea name="tDescripcion" id="tDescripcion" cols="61" rows="10" placeholder="Descripción actividad"></textarea>
                                </div>
                            </div>

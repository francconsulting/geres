    ...
    <div class="login-box-body">
        ...
        <form id="frmCuerpo" name="frmCuerpo" action=""  method="post">
            <div class="form-group has-feedback">
                <input id="usuario"  name="usuario" type="text" class="form-control" placeholder="Email" value="nuevo10">
            ...
            <div class="row">
                ...
                <!-- /.col -->
                <div class="col-xs-4">
                    <button id='btnEnviar' name='btnEnviar' type="submit" class="btn btn-primary btn-block btn-flat">Sign In</button>
                </div>
                <!-- /.col -->
